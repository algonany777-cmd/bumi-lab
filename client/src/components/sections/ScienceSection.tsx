  ...
  return (
    ...
    >
      <div className="container">
        ...
        {/* YouTube video - Korean */}
        <div
          className={`mb-12 transition-all duration-800 ${sectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          style={{ transitionDelay: '400ms' }}
        >
          <div className="flex items-center gap-3 mb-6">
            <span className="font-mono-lab text-[11px] tracking-[0.3em] text-[#A8C5AC] uppercase">
              {lang === 'ko' ? '스피큘 소개 영상' : 'Spicule Introduction Video (KR)'}
            </span>
          </div>
          <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
            <iframe
              ...
              title={lang === 'ko' ? '유니즈랩 스피큘 소개 영상 (한국어)' : 'Unislab Spicule Introduction Video (Korean)'}
              frameBorder="0"
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <span className="font-mono-lab text-[11px] tracking-[0.3em] text-[#A8C5AC] uppercase">
              {lang === 'ko' ? '스피큘 소개 영상 (영어)' : 'Spicule Introduction Video (EN)'}
            </span>
          </div>
          <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
            <iframe
              className="absolute inset-0 w-full h-full"
              src="https://www.youtube.com/embed/mCF_xCyc238?rel=0&modestbranding=1"
              title={lang === 'ko' ? '유니즈랩 스피큘 소개 영상 (영어)' : 'Unislab Spicule Introduction Video (English)'}
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
